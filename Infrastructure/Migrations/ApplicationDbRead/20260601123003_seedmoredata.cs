    ...
    public partial class seedmoredata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-3333-3333-3333-000000000001"), null, "She ___ to school every day.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hành động lặp đi lặp lại ở hiện tại.", null, true, false, 0, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000002"), null, "They usually [play] basketball on weekends.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Có trạng từ 'usually' chỉ thói quen.", null, true, false, 1, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000003"), null, "Look! The cat ___ over the wall.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hành động đang xảy ra lúc nói ('Look!').", null, true, false, 0, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000004"), null, "I [am studying] for my TOEIC exam right now.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Có trạng từ 'right now'.", null, true, false, 1, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000005"), null, "She ___ three cups of coffee today.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hành động đã hoàn thành tính đến hiện tại.", null, true, false, 0, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000006"), null, "We [have seen] this movie before.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Trải nghiệm tính đến thời điểm hiện tại ('before').", null, true, false, 1, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { new Guid("33333333-3333-3333-3333-000000000009"), null, "He ___ to Paris last year.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hành động đã kết thúc trong quá khứ ('last year').", null, true, false, 0, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("33333333-3333-3333-3333-000000000010"), null, "They [won] the match yesterday.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sự việc kết thúc hôm qua ('yesterday').", null, true, false, 1, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { new Guid("33333333-3333-3333-3333-000000000017"), null, "I think it ___ tomorrow.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dự đoán không có căn cứ rõ ràng ('I think').", null, true, false, 0, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    ...
                    { new Guid("33333333-3333-3333-3333-000000000022"), null, "They [will have built] the new bridge by July.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hoàn thành trước tháng 7 tới.", null, true, false, 1, new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
