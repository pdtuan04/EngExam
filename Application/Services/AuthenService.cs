...
namespace Application.Services
{
    public class AuthenService : IAuthService
    {
        ...
        {
            return await _authIdentityService.SignIn(username, password, rememberme);
        }
        ...
        public Task<SignInResponse> LoginByGoogle(string idToken)
        {
            return _authIdentityService.LoginByGoogle(idToken);
        }
